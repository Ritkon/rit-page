...
{{< figure src="guides/utp/grey-1.svg, guides/utp/grey-1-demo.svg" alt="En del från ett underlag på en byggnad där ett av rummen markerats med ett kryss, Del av utrymningsplanen som visar hur ett rum har färglagts med grå färg" caption="" >}}
...
{{< figure src="guides/utp/grey-2.svg, guides/utp/grey-2-demo.svg" alt="Ett exempel där ett rum har markerat med en gul linje längs med ytterkant av området för att indikera att detta ska färgläggas grått på ritningen av utrymningsplanen, Del av utrymningsplanen som visar hur ett rum har färglagts med grå färg" caption="" >}}
